...
To build the final jar and optimize the Boutiqueenligne application for production, run:
...
Then navigate to [http://localhost:8012](http://localhost:8012) in your browser.
